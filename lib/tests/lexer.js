...
describe('The Lexer', function() {
  ...
  it('tokenizes import (flat)', function() {
    var imp = this.l.tokenize('import partial foo');
    expect(imp).toEqual([['IMPORT', 'import'], ['IDENTIFIER', 'partial'], ['IDENTIFIER', 'foo']]);
  });

  it('tokenizes import (path)', function() {
    var imp = this.l.tokenize('import partial foo/bar');
    expect(imp).toEqual([['IMPORT', 'import'], ['IDENTIFIER', 'partial'], ['IDENTIFIER', 'foo/bar']]);
  });
});
